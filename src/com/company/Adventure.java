...
public class Adventure {
    ...
    private void createRooms() {
        ...
        rooms[1] = new Room("Cave", "Dank dark cavern.", false, player); // bats are hanging from the ceiling.
        rooms[2] = new Room("Crawl space", "You are in a tight crawl space.", false, player); // There's an abandoned antidote on the ground.
        rooms[3] = new Room("Sewer", "You entered a sewer.", false, player); // There is a rat running around.
        ...
        rooms[5] = new Room("Security", "You entered a room with a bunch of displays, showing live CCTV footage. The locations seem familiar.", false, player); // There is a golden key on the desk.
        rooms[6] = new Room("Sewage filtration", "You've entered a room with a machine filtrating the sewage.", false, player); //  Someone left a plate of food here, probably lost their appetite.
        rooms[7] = new Room("Golden Door", "You find yourself in a room with a locked giant golden door.", false, player); // A giant snake guards the door.
        rooms[8] = new Room("Back-alley", "You entered a back-alley, seems to connect important areas of this complex.", false, player); // There is a knife on the ground.
    }
    ...
    private void createItems() {
        rooms[2].addItem(new Item("antidote", "an abandoned antidote", ItemType.ANTIDOTE, 1, 20, player));
        rooms[5].addItem(new Item("key", "a golden key", ItemType.KEY, 1, 1, player));
        rooms[6].addItem(new Item("food", "a plate of food", ItemType.FOOD, 30, 40, player));
        rooms[8].addItem(new Item("knife", "a knife", ItemType.KNIFE, 10, 1, player));
    }
